...
namespace Round2.Controllers
{
    ...
    {
        private Round2Context db = new Round2Context();
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Content,CategoryID")] Review review)
        {
            ...
            ViewBag.CategoryID = new SelectList(db.Categories, "ID", "Title", review.CategoryID);
            return View(review);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Content,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
